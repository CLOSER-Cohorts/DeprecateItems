...
When the project loads there are two buttons. The left hand button allows the user to deprecate items. The right had button displays information of variables with the selected dataset including the deprecated state.
